...
veh_summary.to_csv(f'{WORK}/output2_dumper_efficiency.csv', index=False)
...
print(f'\nSaved: output2_dumper_efficiency.csv')
...
veh_cycle.to_csv(f'{WORK}/output3_cycle_segmentation.csv', index=False)
print(f'\nSaved: output3_cycle_segmentation.csv')
...
consistency_summary.to_csv(f'{WORK}/output4_daily_fuel_consistency.csv', index=False)
print(f'\nSaved: output4_daily_fuel_consistency.csv')
...
print('  output2_dumper_efficiency.csv')
print('  output3_cycle_segmentation.csv')
print('  output4_daily_fuel_consistency.csv')